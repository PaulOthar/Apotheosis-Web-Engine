export function render_octal_depthed(frameBuffer, depthBuffer, textureBuffer, SCREEN_WIDTH, screenCoords, screen_y, depthModifier){
...
export function render_octal_safe_depthed(frameBuffer, depthBuffer, textureBuffer, SCREEN_WIDTH, SCREEN_HEIGHT, screenCoords, screen_x, screen_y, depthModifier){
...
export function render_octal_depthed_volatile(frameBuffer, depthBuffer, textureBuffer, SCREEN_WIDTH, screenCoords, screen_y, depthModifier, orientation){
    let depth = screen_y + 64 + depthModifier;
    let color = 0;
...
export function render_octal_safe_depthed_volatile(frameBuffer, depthBuffer, textureBuffer, SCREEN_WIDTH, SCREEN_HEIGHT, screenCoords, screen_x, screen_y, depthModifier, orientation){
    const SCREEN_WIDTH_M32 = SCREEN_WIDTH - 32;
    const SCREEN_HEIGHT_M64 = SCREEN_HEIGHT - 64;
